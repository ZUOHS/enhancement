...
# 加载 XLNet 分词器
tokenizer = XLNetTokenizer.from_pretrained("/root/autodl-tmp/code/enhancement/source/models/xlnet-large-cased")
...
def preprocess_function(examples):
    ...
    return tokenizer(summaries, descriptions, padding="max_length", truncation=True, max_length=512)
...
# 加载 XLNet 模型
model = XLNetForSequenceClassification.from_pretrained("/root/autodl-tmp/code/enhancement/source/models/xlnet-large-cased", num_labels=2)
...
# 保存到 CSV 文件
output_path = "/root/autodl-tmp/code/enhancement/source/BERTS2/xlnet-large/test_results.csv"
...
metrics_path = "/root/autodl-tmp/code/enhancement/source/BERTS2/xlnet-large/test_metrics.csv"
