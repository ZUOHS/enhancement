...
# 加载 XLNet 分词器
tokenizer = BertTokenizer.from_pretrained("/root/autodl-tmp/code/enhancement/source/models/bert-large-uncased")
...
# 加载 XLNet 模型
model = BertForSequenceClassification.from_pretrained("/root/autodl-tmp/code/enhancement/source/models/bert-large-uncased", num_labels=2)
...
# 保存到 CSV 文件
output_path = "/root/autodl-tmp/code/enhancement/source/BERT-PROFILE/bert-large/test_results.csv"
...
metrics_path = "/root/autodl-tmp/code/enhancement/source/BERT-PROFILE/bert-large/test_metrics.csv"
