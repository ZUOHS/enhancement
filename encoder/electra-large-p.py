...
# 加载 XLNet 分词器
tokenizer = ElectraTokenizer.from_pretrained("/root/autodl-tmp/code/enhancement/source/models/electra-large-discriminator")
...
# 保存到 CSV 文件
output_path = "/root/autodl-tmp/code/enhancement/source/BERT-PROFILE/electra-large/test_results.csv"
...
metrics_path = "/root/autodl-tmp/code/enhancement/source/BERT-PROFILE/electra-large/test_metrics.csv"
