...
# 加载 XLNet 分词器
tokenizer = XLNetTokenizer.from_pretrained("/root/autodl-tmp/code/enhancement/source/models/xlnet-base-cased")
...
# 加载 XLNet 模型
model = XLNetForSequenceClassification.from_pretrained("/root/autodl-tmp/code/enhancement/source/models/xlnet-base-cased", num_labels=2)
...
# 保存到 CSV 文件
output_path = "/root/autodl-tmp/code/enhancement/source/BERTS2/xlnet/test_results.csv"
...
metrics_path = "/root/autodl-tmp/code/enhancement/source/BERTS2/xlnet/test_metrics.csv"
