...
# 保存到 CSV 文件
output_path = "/root/autodl-tmp/code/enhancement/source/BERT-PROFILE/xlnet/test_results.csv"
...
metrics_path = "/root/autodl-tmp/code/enhancement/source/BERT-PROFILE/xlnet/test_metrics.csv"
