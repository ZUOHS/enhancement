...
# 加载 XLNet 分词器
tokenizer = DebertaV2Tokenizer.from_pretrained("/root/autodl-tmp/code/enhancement/source/models/deberta-v3-large")
...
# 加载 XLNet 模型
model = DebertaV2ForSequenceClassification.from_pretrained("/root/autodl-tmp/code/enhancement/source/models/deberta-v3-large", num_labels=2)
...
# 保存到 CSV 文件
output_path = "/root/autodl-tmp/code/enhancement/source/BERT-PROFILE/deberta-large/test_results.csv"
...
metrics_path = "/root/autodl-tmp/code/enhancement/source/BERT-PROFILE/deberta-large/test_metrics.csv"
