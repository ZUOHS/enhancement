...
# 加载 XLNet 分词器
tokenizer = RobertaTokenizer.from_pretrained("/root/autodl-tmp/code/enhancement/source/models/roberta-base")
...
# 加载 XLNet 模型
model = RobertaForSequenceClassification.from_pretrained("/root/autodl-tmp/code/enhancement/source/models/roberta-base", num_labels=2)
...
# 保存到 CSV 文件
output_path = "/root/autodl-tmp/code/enhancement/source/BERTS2/roberta/test_results.csv"
...
metrics_path = "/root/autodl-tmp/code/enhancement/source/BERTS2/roberta/test_metrics.csv"
